...
I made this 'blog' so that I could have an outspoken voice without actually doing the talking *(some would call it autism)*, so you'll find random thoughts in here about anything that I feel like talking about, especially movie reviews.
